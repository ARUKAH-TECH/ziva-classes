...
export default async function ParentTerminalReportsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-ink-500">Published reports for your children.</p>
      </div>
        ...
        <CardContent>
          {reports.length === 0 ? (
            <EmptyState
              ...
              description="Once a terminal report is published, it will appear here."
            />
          ) : (
            <Table>
              <THead>
                ...
                {reports.map((r) => (
                  <TR key={r.id}>
                    ...
                    <TD className="text-right">
                      <Link href={`/parent/terminal-reports/${r.id}`}>
